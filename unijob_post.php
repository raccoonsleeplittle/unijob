...
<br>
  ...
  <a href="#" class="list-group-item list-group-item-action">สถานะงาน</a>
...
<fieldset class="form-group">
  ...
  <div class="row">
  <div class="col-6">
    <label for="exampleInputPassword1">ชื่อผู้จ้าง</label>
    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="กรุณากรอกชื่อผู้จ้าง">
  </div>
  <div class="col-6">
  ...
  <label for="exampleInputPassword1">เบอร์ติดต่อ</label>
    <input type="input" class="form-control"  placeholder="กรุณากรอกเบอร์ติดต่อ">
  </div>
  </div>
  <br>
  <div class="row">
